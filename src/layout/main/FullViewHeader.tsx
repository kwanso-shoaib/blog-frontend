...
import { FullViewHeaderProps } from "../../types";
    ...
    <>
      <Stack direction="row">
        <Stack direction="row" alignItems="center">
          <GreyBox />
          <NavBar isLoggedIn={isLoggedIn} data={HEADER_NAV_LINKS} />
        </Stack>
          ...
          {isLoggedIn ? (
            <>
              <Box sx={{ marginLeft: "20px" }}>
                <HeaderButton
                  variant="contained"
                  onClick={() => navigate(ROUTES_PATH.createPost)}
                >
                  Create Article
                </HeaderButton>
              </Box>
            ...
            <>
              <Box sx={{ marginLeft: "20px" }}>
                <HeaderButton
                  variant="outlined"
                  onClick={() => navigate(ROUTES_PATH.signin)}
                >
                  Log in
                </HeaderButton>
              </Box>
